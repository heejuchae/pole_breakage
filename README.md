...
- `7. train_break_pattern_resnet_bbox_confidence backup.py`, `8. train_break_pattern_resnet_binary_from_bbox backup.py`: 메인 스크립트 백업본
- `9. test_break_pattern_resnet_bbox_confidence.py`: 7번 모델 관련 테스트용
